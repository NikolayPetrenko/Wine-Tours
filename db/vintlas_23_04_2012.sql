...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 MIN_ROWS=4 MAX_ROWS=13;
...
INSERT INTO `users` (`id`, `name`, `firstname`, `surname`, `email`, `company`, `country_id`, `avatar`, `zone_id`, `password`, `reg_id`, `status`, `privacy`, `involves`, `role`) VALUES 
  ...
  (2,'xc','cxcx','cxc','admin@mail.ru','','AF','1335189117_sample-th','1','dad3a37aa9d50688b5157698acfd7aee','6748410361b327955a7496b0fe171320',0,'Personal contact form','Wine Retailer; ','user');
COMMIT;
