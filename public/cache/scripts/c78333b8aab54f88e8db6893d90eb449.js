...
$(function(){
	$('#all').change(function(){
		if($('#all').attr("checked") == "checked"){
			...
			$('.vin').replaceWith('<input type="checkbox" name="vin" value="a1" id="vin" class="jNiceHidden type" style="opacity: 0; ">');
			$('#vin').next('label').css('color', '#35424A');
			$('#vin').closest('.oneLine').jNice();
			$('.win').replaceWith('<input type="checkbox" name="win" value="a1" id="win" class="jNiceHidden type" style="opacity: 0; ">');
			$('#win').next('label').css('color', '#35424A');
			$('#win').closest('.oneLine').jNice();
			$('.reg').replaceWith('<input type="checkbox" name="reg" value="a1" id="reg" class="jNiceHidden type" style="opacity: 0; ">');
			$('#reg').next('label').css('color', '#35424A');					
			$('#reg').closest('.oneLine').jNice();
		}
	})
	$('#vin').next('label').css('color', 'gray');
	$('#win').next('label').css('color', 'gray');
	$('#reg').next('label').css('color', 'gray');
	$('#vin').replaceWith('<span class="jNiceWrapper vin"><img src="/images/ckeckbox-disabled.png"></span>');		
	$('#win').replaceWith('<span class="jNiceWrapper win"><img src="/images/ckeckbox-disabled.png"></span>');
	$('#reg').replaceWith('<span class="jNiceWrapper reg"><img src="/images/ckeckbox-disabled.png"></span>');	
})
