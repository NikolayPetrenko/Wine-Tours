...
$(document).ready(
	...
	$('#all').change(function(){
		if($('#all').attr("checked") == "checked"){
			...
			$('.vin').replaceWith('<input type="checkbox" name="type[vin]" value="vin" id="vin" class="type jNiceHidden" style="opacity: 0; ">');
			$('#vin').closest('.oneLine').jNice();
			$('.win').replaceWith('<input type="checkbox" name="type[win]" value="win" id="win" class="type jNiceHidden" style="opacity: 0; ">');
			$('#win').closest('.oneLine').jNice();
			$('.reg').replaceWith('<input type="checkbox" name="type[reg]" value="reg" id="reg" class="type jNiceHidden" style="opacity: 0; ">');
